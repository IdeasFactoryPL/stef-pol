		...
		<div class="header-body">		
			<div class="container">
				 <div class="row logo-row">
				  <div class="info-kontaktowe">
				  	
				  	<h3>POLSKI PRODUCENT PROSTOWNIKÓW I&nbsp;AUTOMATYCZNYCH ŁADOWAREK</h3>

					<p>P.P.U.H. STEF-POL<br>
					05-840 Brwinów, ul. Paszkowskiego 6<br>
					tel./fax: (22) 729 77 30<br>
					e-mail</p>
				  </div>
				  
				  <div class="col-md-4 ciagnij-right">
					<?php if ( $site_logo != '' ) : ?>
